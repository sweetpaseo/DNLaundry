        ...
        <form onSubmit={(e) => { 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
            ...
            <div className="form-group">
              ...
              >
                <option value="service" style={{ color: '#0F172A', background: '#ffffff' }}>Service (Jasa)</option>
                <option value="product" style={{ color: '#0F172A', background: '#ffffff' }}>Product (Barang)</option>
              </select>
            </div>
          </div>
